...
description: A start-to-finish masterclass on Claude Code, built up as a README of strategies in Cole's context-engineering repo. He walks through global rules, permissions, custom slash commands, MCP servers (Serena, Archon), the PRP framework, sub-agents, hooks, the GitHub CLI, YOLO mode in dev containers, and parallel agents via git worktrees - stressing how each generalizes to any AI coding assistant.
---
