...
- [MCP as the Integration Layer for AI Coding](concepts/mcp-integration-layer.md) - Model Context Protocol is the standard wiring Cole uses to plug knowledge
